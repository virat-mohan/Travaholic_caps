...
const FIELDS: { key: string; label: string; hint: string }[] = [
  ...
  { key: "MSG91_OTP_TEMPLATE_ID", label: "MSG91 OTP Template/Flow ID", hint: "One variable (VAR1) for the code — set its channel routing to WhatsApp→SMS in the MSG91 dashboard." },
  { key: "MSG91_ORDER_CONFIRMATION_TEMPLATE_ID", label: "MSG91 Order Confirmation Template ID", hint: "Three variables in order: customer name, order number, total." },
  { key: "MSG91_ABANDONED_CART_TEMPLATE_ID", label: "MSG91 Abandoned Cart Template ID", hint: "Two variables in order: customer name, item summary." },
